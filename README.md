...
## About
This repository contains an updated version of **Under Siege**. The goal is to fix compatibility issues, resolve bugs and ensure the mod remains available for the community.
Unless otherwise stated, I do **not** claim ownership of the original work. Full credit belongs to the original creator(s).

---

## Credits
**Original Author:** [Oatmeal Problem](https://steamcommunity.com/id/OatmealProblem)

**Original Mod Page:** [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=2786268200)

*Revived Mod Page:** [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3771629021)

**Revived Source Repository:** [Github Repository](https://github.com/Stellaris-Revived-Project/Under-Siege-Revived)
